...
MODULES = [
    ...
    ('challenge-speeches', 'src/challenges/challenge-speeches.js'),
    ('challenge-codec', 'src/challenges/challenge-codec.js'),
    ('challenge-qr', 'src/challenges/challenge-qr.js'),
    ('challenge-qr-decoder', 'src/challenges/qr-decoder.js'),
    ('challenge-record-service', 'src/challenges/record-service.js'),
    ('challenge-service', 'src/challenges/challenge-service.js'),
    ('challenge-ui', 'src/challenges/challenge-ui.js'),
    ('challenge-router', 'src/challenges/challenge-router.js'),
    ...
    ('challenge-app-integration', 'src/challenges/app-integration.js'),
...
REQUIRED = [
    ...
    '__THChallenges',
    '__THChallengeService',
    '__THChallengeCodec',
    '__THChallengeRouter',
    '__THSpeeches',
    '__THQR',
    'trainhard_v1_challenges',
    'challenge_created',
    'challenge_joined',
    'challenge_completed',
    'Челленджи',
    'th-mvp-challenge-router',
    'th-mvp-challenge-app-integration',
    '__THAppIntegration',
    'thStreakFix',
    'Серия обновилась',
    '__THQRDecode',
